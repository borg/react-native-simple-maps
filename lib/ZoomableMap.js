...
var _reactNativeSimpleSvgPanZoom = _interopRequireWildcard(require("react-native-simple-svg-pan-zoom"));
  ...
  _createClass(ZoomableMap, [{
    ...
    value: function render() {
      ...
      return (// <View {...this._panResponder.panHandlers}>
        _react["default"].createElement(_reactNativeSimpleSvgPanZoom["default"], _extends({
          canvasHeight: height,
          canvasWidth: width,
          minScale: 0.5,
          maxScale: 10,
